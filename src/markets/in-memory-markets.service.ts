...
export interface Market {
  marketId: string;
  onChainMarketId?: string; // Alpha: Address of on-chain market resource
  question: string;
  outcomes: string[];
  ...
  private seedMarket() {
    ...
    controversies.forEach((c: any) => {
      const market: Market = {
        marketId: c.id,
        onChainMarketId:
          '0xf91de408f7f59f661f28aa2ebbb086bba63a846856954191877d6f8768e8f138', // Alpha: Use Module Address (Admin Market)
        question: c.title,
        ...
        resolutionTime: new Date(
          new Date(c.closeTime).getTime() + 24 * 60 * 60 * 1000,
        ),
