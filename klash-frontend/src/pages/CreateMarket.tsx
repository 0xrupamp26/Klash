  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-8 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bungee mb-2 text-klash animate-fade-in">Create Your Own Market</h1>
          <p className="text-muted-foreground text-lg animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Share your opinion and let others bet on any controversy
          </p>
        </div>
