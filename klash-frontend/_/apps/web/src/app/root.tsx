...
// import { PetraWallet } from "petra-plugin-wallet-adapter"; // If installed, else rely on standard
import "@aptos-labs/wallet-adapter-ant-design/dist/index.css"; // Optional if using UI

const wallets = [/* new PetraWallet() */]; // Auto-detect works for standard wallets
